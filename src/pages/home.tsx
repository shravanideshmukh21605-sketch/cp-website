...
export default function Home() {
  ...
  return (
    <Box style={{ width: '100vw', minHeight: '100vh', backgroundColor: '#0a0a0a' }}>
      
      {/* 1. Transparent Premium Header - MODIFIED FOR BETTER READABILITY */}
      <Box
        style={{
          position: 'fixed',
          top: 0,
      ...
      >
        <Container size="xl" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Group gap="xs">
            ...
            <Text size="xl" fw={900} c="white" style={{ letterSpacing: '3px', textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
              PUREFRAME LABS
            </Text>
          </Group>

          <Group gap="xl" visibleFrom="sm">
            {/* MODIFICATION: Wrapped items in a group for consistent alignment and bolder fonts */}
            <Group gap={35} mr={20}>
            ...
            <Button 
              variant="filled" // Changed to filled for immediate recognition
              color="white" 
              c="black"
              radius="xl" 
              fw={800}
      ...
      {/* Global CSS for Navigation Modification */}
      <style>{`
      ...
      <Box style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden' }}>
        ...
        <Container size="xl" style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', alignItems: 'center' }}>
          <Box style={{ maxWidth: '800px', textAlign: 'left' }}>
            ...
            <Title
              ...
              c="white"
              style={{
                fontSize: isMobile ? '3.5rem' : '6rem', // Increased size
                fontWeight: 900,
                lineHeight: 0.9,
                opacity: isVisible ? 1 : 0,
                transform: isVisible ? 'translateY(0)' : 'translateY(30px)',
                transition: '0.8s',
                textShadow: '0 4px 15px rgba(0,0,0,0.8)' // Added shadow
              }}
            >
              Find Your
            </Title>
            <Title
              ...
              c="#FF6B35"
              style={{
                fontSize: isMobile ? '4rem' : '8rem', // Increased size
                fontWeight: 900,
                lineHeight: 1,
                marginBottom: '35px',
                opacity: isVisible ? 1 : 0,
                ...
                textShadow: '0 4px 15px rgba(0,0,0,0.5)' // Added shadow
              }}
            >
              Dream Home.
            </Title>
      ...
      <Box py={100} style={{ backgroundColor: '#0a0a0a' }}>
        <Container size="xl">
          <Group justify="space-between" mb={60} align="flex-end">
            ...
            <Button variant="subtle" color="orange" size="xl" fw={800}>View All</Button>
          </Group>
            ...
            {mockProperties.map((prop) => (
              <Card 
                ...
                style={{ 
                  ...
                  border: '1px solid rgba(255,255,255,0.08)', // Slightly clearer border
              ...
              >
                <Card.Section>
                  <Image src={prop.img} height={280} alt={prop.title} />
                </Card.Section>
                <Group justify="space-between" mt="md">
                  <Text c="white" fw={800} size="xl">{prop.title}</Text>
                  <Badge color="orange" variant="filled" size="xl" fw={900}>₹ {prop.price}</Badge>
                </Group>
                <Group gap="xs" mt="sm">
                ...
                <Group gap="xs" mt={5}>
                  <IconBed size={18} color="#FF6B35" />
                  <Text size="sm" c="gray.4" fw={600}>{prop.bhk}</Text>
                </Group>
                <Button fullWidth color="orange" variant="light" mt="xl" radius="md" fw={700} size="md">View details</Button>
              </Card>
            ))}
          </SimpleGrid>
        </Container>
      ...
      <Drawer
        ...
        styles={{
          ...
          header: { backgroundColor: '#0a0a0a', color: 'white', borderBottom: '1px solid #333' }
        }}
      >
        <Stack gap="xl" mt="md">
          <Box>
            <Text c="orange" fw={800} size="sm" tt="uppercase" mb="md" style={{ letterSpacing: '1px' }}>Personal Information</Text>
            <Stack gap="sm">
              <Group justify="space-between">
                <Group gap="sm"><IconMail size={18} color="orange"/><Text size="sm" fw={500}>Email</Text></Group>
                <Text size="sm" fw={700}>gayatrirade98@gmail.com</Text>
              </Group>
              <Group justify="space-between">
                <Group gap="sm"><IconId size={18} color="orange"/><Text size="sm" fw={500}>Aadhar Verification</Text></Group>
                <Badge color="green" variant="filled" fw={900}>Verified</Badge>
              </Group>
              <Group justify="space-between">
                <Group gap="sm"><IconPhone size={18} color="orange"/><Text size="sm" fw={500}>Mobile</Text></Group>
                <Text size="sm" fw={700}>+91 98765 43210</Text>
              </Group>
              <Group justify="space-between">
                <Group gap="sm"><IconMapPin size={18} color="orange" /><Text size="sm" fw={500}>Location</Text></Group>
                <Text size="sm" fw={700}>Akola, Maharashtra</Text>
              </Group>
            </Stack>
          </Box>
          ...
          <Box>
            <Text c="orange" fw={800} size="sm" tt="uppercase" mb="md" style={{ letterSpacing: '1px' }}>Your Activity</Text>
            <Stack gap="sm">
              <Button fullWidth variant="light" color="gray" leftSection={<IconBookmark size={20}/>} justify="space-between" rightSection={<Badge radius="sm">12</Badge>} fw={700}>
                Saved Properties
              </Button>
              <Button fullWidth variant="light" color="gray" leftSection={<IconHistory size={20}/>} justify="space-between" rightSection={<Badge radius="sm">45</Badge>} fw={700}>
                Search History
              </Button>
            </Stack>
          </Box>
          ...
          <Button fullWidth variant="subtle" color="red" fw={700}>Logout Account</Button>
        </Stack>
      </Drawer>

      <Box py={60} style={{ textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <Text c="gray.6" size="sm" fw={500}>© 2026 Pureframe Labs Private Limited. Excellence in Indian Real Estate.</Text>
      </Box>
    </Box>
  );
}